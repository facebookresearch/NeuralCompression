...
class PriorAutoencoder(LightningModule):
    ...
    def predict_dataloader(self) -> EVAL_DATALOADERS:
        return super(PriorAutoencoder, self).predict_dataloader()
    ...
    def test_dataloader(self) -> EVAL_DATALOADERS:
        return super(PriorAutoencoder, self).test_dataloader()

    def train_dataloader(self) -> TRAIN_DATALOADERS:
        return super(PriorAutoencoder, self).train_dataloader()
    ...
    def val_dataloader(self) -> EVAL_DATALOADERS:
        return super(PriorAutoencoder, self).val_dataloader()
